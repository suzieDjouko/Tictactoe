...
public class TicTacToe implements  ActionListener{
    ...
    // frame.setSize(420, 420) set the dimension , x and y  , frame.setResizable(false)
    // frame.setTitle ("") set the Title to the Frame
    // ImageIcon image = new ImageIcon ("")
    // frame.setIconImage ( image.getImage());
    JPanel title_panel = new JPanel();
    JPanel button_panel = new JPanel();
    JButton[] buttons = new JButton[9];
    JLabel textfield = new JLabel(); // a GUI display area for a string of txt  an image or both
    ...
    TicTacToe(){
        ...
        title_panel.setBounds(0,0,600,100); // we want to start on the tof left corner
        ...
        frame.add(title_panel, BorderLayout.NORTH); // add the Panel to the Frame
    ...
    public void firstTurn(){
        // add a delay before somebody is going to turn
        try {
            Thread.sleep(2000);
